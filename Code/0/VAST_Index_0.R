...
load("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/YFT_1area_observations_1_100_ESS_00x.RData")
plot(dat_1A_1$CPUE$cpu)

write.csv(dat_1A_1$CPUE,file="D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/VAST_Index/VAST_Index_0/CPUE.csv",row.names = FALSE)

settings = make_settings( n_x=160, Region="Other", purpose="index2",max_cells=Inf,use_anisotropy=FALSE,
                          strata.limits=data.frame('STRATA'=c("IO")), bias.correct=FALSE, ObsModel=c(1,3),
                          RhoConfig=c("Beta1"=0, "Beta2"=0, "Epsilon1"=0, "Epsilon2"=0), fine_scale = FALSE )


dir <- "D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/VAST_Index/VAST_Index_0/"
dir.create(dir)
setwd(dir)
