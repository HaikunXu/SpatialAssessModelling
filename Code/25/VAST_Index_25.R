...
load("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/YFT_1area_observations_1_100_ESS_25.RData")
plot(dat_1A_1$CPUE$cpu)

write.csv(dat_1A_1$CPUE,file="C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/VAST_Index/VAST_Index_25/CPUE.csv",row.names = FALSE)
...
dir <- "C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/VAST_Index/VAST_Index_25/"
dir.create(dir)
setwd(dir)
