...
PS_LF <- read.csv("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Tree/PS/PS_LF_5.csv")
# new PS LF
PS_LF <- PS_LF %>%
...
# LL_LF <- read.csv("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Tree/LL/LL_LF_25.csv")
# # new LL LF
# LL_LF <- LL_LF %>%
#   mutate(Yr=(year-1)*4+quarter,
#          Seas=1,
...
# # write data file
SS_writedat(data,outfile = "C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_25_rt/test_data.ss",version = "3.24",overwrite = TRUE)

# fix a bug in r4ss
File <- readLines("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_25_rt/test_data.ss", warn = F)
File[19] = "1 #_Nsexes"
...
writeLines(File, "C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_25_rt/test_data.ss")
