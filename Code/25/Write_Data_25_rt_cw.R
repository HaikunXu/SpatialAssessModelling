...
PS_Catch <- read.csv("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Tree/PS/PS_Catch_5.csv")
PS_Catch <- PS_Catch %>%
  spread(Cell,Total_Catch)
Catch[,11:13] <- PS_Catch[3:5] / 1000

# LL_Catch <- read.csv("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Tree/LL/LL_Catch_5.csv")
# LL_Catch <- LL_Catch %>%
#   spread(Cell,Total_Catch)
...
PS_LF <- read.csv("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Tree/PS/PS_LF_5_cw.csv")
# new PS LF
PS_LF <- PS_LF %>%
...
# LL_LF <- read.csv("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Tree/LL/LL_LF_5_cw.csv")
# # new LL LF
# LL_LF <- LL_LF %>%
#   mutate(Yr=(year-1)*4+quarter,
#          Seas=1,
...
# # write data file
SS_writedat(data,outfile = "C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_25_rt_cw/test_data.ss",version = "3.24",overwrite = TRUE)

# fix a bug in r4ss
File <- readLines("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_25_rt_cw/test_data.ss", warn = F)
File[19] = "1 #_Nsexes"
...
writeLines(File, "C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_25_rt_cw/test_data.ss")
