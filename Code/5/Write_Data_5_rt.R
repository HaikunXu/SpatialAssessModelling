...
load("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/YFT_SRD_4A_4.RData")
...
PS_Catch <- read.csv("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Tree/PS/PS_Catch_5.csv")
PS_Catch <- PS_Catch %>%
...
PS_LF <- read.csv("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Tree/PS/PS_LF_5.csv")
# new PS LF
PS_LF <- PS_LF %>%
...
# # write data file
SS_writedat(data,outfile = "D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_5_rt/test_data.ss",version = "3.24",overwrite = TRUE)

# fix a bug in r4ss
File <- readLines("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_5_rt/test_data.ss", warn = F)
File[19] = "1 #_Nsexes"
...
# Survey LF
SS_LF <- read.csv(file="D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/VAST_LF/VAST_LF_5 - Copy/SS.csv")
# SS_LF$Nsamp <- 5
...
writeLines(File, "D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_5_rt/test_data.ss")
