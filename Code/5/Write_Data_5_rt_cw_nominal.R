...
CPUE_Nominal <- read.csv("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Nominal_CPUE.csv")
CPUE$Estimate_metric_tons <- CPUE_Nominal$cpue
...
# # write data file
SS_writedat(data,outfile = "D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_5_rt_cw_nominal/test_data.ss",version = "3.24",overwrite = TRUE)

# fix a bug in r4ss
File <- readLines("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_5_rt_cw_nominal/test_data.ss", warn = F)
File[19] = "1 #_Nsexes"
...
writeLines(File, "D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_5_rt_cw_nominal/test_data.ss")
