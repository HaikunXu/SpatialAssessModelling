...
ggsave(f0,file="Data/CPUE_0.png", width = 24, height = 16)

save(Data_Geostat,file="Data/CPUE_0.RData")
...
ggsave(f1,file="Data/LL_LF_0.png", width = 10, height = 8)

save(LF_DF,file="Data/LL_LF_0.RData")
...
write.csv(LL_LF,file="Data/LL_LF_Nominal_0.csv",row.names = FALSE)
...
ggsave(f2, file="Data/PS_LF_0.png", width = 10, height = 8)

save(LF_DF, file="Data/PS_LF_0.RData")
...
save(Catch_DF, file="Data/PS_Catch_0.RData")
...
save(Catch_DF, file="Data/LL_Catch_0.RData")