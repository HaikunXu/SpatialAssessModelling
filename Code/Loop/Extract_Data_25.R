...
save(Data_Geostat,file="CPUE_25.RData")
...
save(LF_DF,file="LL_LF_25.RData")
...
save(LF_DF, file="PS_LF_25.RData")
...
save(Catch_DF, file="PS_Catch_25.RData")
...
save(Catch_DF, file="LL_Catch_25.RData")
