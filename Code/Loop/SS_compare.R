...
Path <- c(paste0("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/Loop/test_5/",c(1:8)),
          paste0("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/Loop/test_5_rt/",c(1:8)),
          paste0("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/Loop/test_5_rt_cw/",c(1:8)))
...
profilesummary <- SSsummarize(profilemodels[1:24])

Par <- profilesummary$pars

Q_extra <- as.numeric(profilesummary$pars[which(profilesummary$pars$Label == "Q_extraSD_17_llcpue"), 1:24])
