...
for (i in c(1:46,48:52,54:84,86:100)) {
  ...
  loop_dir <- paste0("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/Loop/test_5_onearea/",i,"/")
  dir.create(loop_dir)
  
  Path <- "C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_5_onearea/"
  files = c(
  ...
  N_PS <- read.csv(paste0("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Loop/",i,"/PS_5_N_onearea.csv"))
