...
load("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/YFT_1area_observations_1_100_ESS_05.RData")
source("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Code/Loop/Loop.R")

for (i in c(1:46,48:52,54:84,86:100)) {
  # create a new folder for SS files
  loop_dir <- paste0("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/Loop/test_5_onearea_cw/",i,"/")
  dir.create(loop_dir)
  
  Path <- "C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_5_onearea_cw/"
  files = c(
  ...
  N_LL <- read.csv(paste0("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Loop/",i,"/LL_5_N_onearea.csv"))
  LF0$Nsamp[which(LF0$FltSvy %in% 3)] <- N_LL$n
  
  PS_LF <- read.csv(paste0("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Loop/",i,"/PS_LF_5_onearea_cw.csv"))
