...
for (i in 1:10) {
  ...
  loop_dir <- paste0("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/Loop/test_5_rt_cw/",i,"/")
  dir.create(loop_dir)
  ...
  PS_LF <- read.csv(paste0("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Loop/",i,"/PS_LF_5_cw.csv"))
