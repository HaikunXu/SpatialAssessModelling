...
for (i in 1:1) { #c(1:46,48:52,54:84,86:100)) {
  # create a new folder for SS files
  loop_dir <- paste0("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/Loop/test_5_rt_cw_nominal/",i,"/")
  dir.create(loop_dir)
  
  Path <- "C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_5_rt_cw_nominal/"
  files = c(
  ...
  CPUE_Nominal <- read.csv(paste0("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Loop/",i,"/Nominal_Index.csv"))
  ...
  PS_LF <- read.csv(paste0("C:/Users/hkxu/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Loop/",i,"/PS_LF_5_cw.csv"))
