...
Nsamp <- read.csv("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/VAST_LF/Nsamp.csv")
...
write.csv(LF_SS,file="D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/VAST_LF/SS.csv",row.names = FALSE)
