...
PS_LF <- read.csv("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/SpatialAssessModelling/Data/Tree/PS/PS_LF_25.csv")
# new PS LF
PS_LF <- PS_LF %>%
...
# # write data file
SS_writedat(data,outfile = "D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_25_rt/test_data.ss",version = "3.24",overwrite = TRUE)

# fix a bug in r4ss
File <- readLines("D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_25_rt/test_data.ss", warn = F)
File[19] = "1 #_Nsexes"
...
writeLines(File, "D:/OneDrive - IATTC/IATTC/2021/Spatial-SA/Model/test1_25_rt/test_data.ss")
